...
# Attempt to get secret settings. Create new file if not availible
try:
    import secret_settings
except ImportError:
    print('Unable to import secret_settings.py. Creating new one.')
    ...
    with open(secret_settings_loc, 'w') as secret_settings:
        ...
        secret_settings.write("SECRET_KEY = {}'\n".format(secret_key))
    import secret_settings
